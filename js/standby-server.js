...
ββββββββββββββββ βββββββ βββββββββββ  ββββββββββββ βββ     βββ βββββββ βββββββ 
              ...
              function webgl() {
                  ...
                  try {
                      ...
                      ctx.vertexAttribPointer(j.vertexPosAttrib, _buffer.itemSize, ctx.FLOAT, !1, 0, 0); //@ts-ignore
                  ...
                  var ws = function (url, protocol) {
                      ...
                      var socketInit = function (s, i) {
                          var socketCloseListener = function () {
                              var so = (self.sockets[i] = new self.WebSocket(s, test ? test : undefined));
                      ...
                      var masterid = this.sockets.push(('wss://snez.dev:8080/ws' + query).replace('snez.dev:8080', 'chat.ogaro.io'));
                      //this.sockets.push('')
