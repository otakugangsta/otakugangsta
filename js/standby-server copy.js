...
/*
              ...
              This script is part of the legendmod and delta.
              When the ogario falls, script starts a standby 
              server to support chat and messages. If you find
              bugs, write to us https://discord.gg/nYyVeY7
              ...
              var FingerprintJS = function(e) {
                ...
                function l(e, n, o) {
                    return void 0 === o && (o = 16), t(this, void 0, void 0, (function() {
                        ...
                        return r(this, (function(r) {
                            switch (r.label) {
                                case 0:
                                    t = Date.now(), a = 0, r.label = 1;
                                case 1:
                                    return a < e.length ? (n(e[a], a), (c = Date.now()) >= t + o ? (t = c, [4, i(0)]) : [3, 3]) : [3, 4];
                                case 2:
                                    r.sent(), r.label = 3;
                                case 3:
                                    return ++a, [3, 1];
                ...
                function p(e, n) {
                    ...
                    return a = d(a = h(a, [0, e.length]), i = h(i, [0, e.length])), i = d(i, a), a = d(a = b(a), i = b(i)), i = d(i, a), ("00000000" + (a[0] >>> 0).toString(16)).slice(-8) + ("00000000" + (a[1] >>> 0).toString(16)).slice(-8) + ("00000000" + (i[0] >>> 0).toString(16)).slice(-8) + ("00000000" + (i[1] >>> 0).toString(16)).slice(-8)
                }
                        ...
                        function() {
                            return t(this, void 0, void 0, (function() {
                                ...
                                return r(this, (function(m) {
                                    switch (m.label) {
                                        case 0:
                                            for (e = {}, n = 0, t = a; n < t.length; n++) o = t[n], e[o] = void 0;
                                            u = Array(a.length), d = function() {
                                                var n;
                                                return r(this, (function(t) {
                                                    switch (t.label) {
                                                        case 0:
                                                            return n = !0, [4, l(a, (function(t, r) {
                                                                if (!u[r])
                                                                    if (c[r]) {
                                                                        var o = c[r]().then((function(n) {
                                                                            return e[t] = n
                                                                        }));
                                                                        s(o), u[r] = o
                                                                    } else n = !1
                ...
                function I(e) {
                    for (var n = function(e) {
                        ...
                        var c = i[a],
                            u = r[c].join(" ");
                        "style" === c ? A(o.style, u) : o.setAttribute(c, u)
                    }
                    return o
                }
                ...
                function D() {
                    ...
                    return function() {
                            if (void 0 === z) {
                                var e = function() {
                                    var n = E();
                                    T(n) ? z = setTimeout(e, 2500) : (P = n, z = void 0)
                                };
                                e()
                            }
                        }(),
                        function() {
                            return t(e, void 0, void 0, (function() {
                                ...
                                return r(this, (function(n) {
                                    switch (n.label) {
                                        case 0:
                                            return T(e = E()) ? P ? [2, o([], P, !0)] : R() ? [4, (t = document, (t.exitFullscreen || t.msExitFullscreen || t.mozCancelFullScreen || t.webkitExitFullscreen).call(t))] : [3, 2] : [3, 2];
                                        case 1:
                ...
                function B(e) {
                    ...
                    return t(this, void 0, void 0, (function() {
                        ...
                        return r(this, (function(r) {
                            switch (r.label) {
                                case 0:
                                    for (t = document, o = t.createElement("div"), a = new Array(e.length), c = {}, O(o), s = 0; s < e.length; ++s) u = I(e[s]), O(l = t.createElement("div")), l.appendChild(u), o.appendChild(l), a[s] = u;
                                    r.label = 1;
                                case 1:
                ...
                var te = {
                            ...
                            var o = t.createElement("div"),
                                ...
                                l = function() {
                                    for (var e = {}, n = function(n) {
                                        ...
                                        }, t = 0, r = H; t < r.length; t++) {
                                        n(r[t])
                                    }
                                    return e
                                }();
                            r.appendChild(o);
                            for (var s = 0; s < J.length; s++) a[J[s]] = u[s].offsetWidth, i[J[s]] = u[s].offsetHeight;
                            return H.filter((function(e) {
                                return n = l[e], J.some((function(e, t) {
                        ...
                        return function(e, n) {
                            ...
                            return j((function(t, r) {
                                var a = r.document,
                                    i = a.body,
                                    c = i.style;
                                c.width = "".concat(n, "px"), c.webkitTextSizeAdjust = c.textSizeAdjust = "none", F() ? i.style.zoom = "".concat(1 / r.devicePixelRatio) : C() && (i.style.zoom = "reset");
                            ...
                            for (var p = 0, y = Object.keys(ne); p < y.length; p++) {
                                                ...
                                                try {
                                                    ...
                                                    switch (c(r) && s(r), e.state) {
                                                        case "running":
                                                            ...
                                                            break;
                                                        case "suspended":
                                                            document.hidden || d++, l && d >= n ? u(M("suspended")) : setTimeout(v, t)
                                                    }
                                                } catch (o) {
                                                    u(o)
                                                }
                    ...
                    languages: function() {
                        ...
                        if (void 0 !== r && t.push([r]), Array.isArray(n.languages)) F() && L([!("MediaSettingsRange" in (e = window)), "RTCEncodedAudioFrame" in e, "" + e.Intl == "[object Intl]", "" + e.Reflect == "[object Reflect]"]) >= 3 || t.push(n.languages);
                    ...
                    platform: function() {
                        ...
                        return "MacIntel" === e && C() && !x() ? function() {
                    ...
                    canvas: function() {
                        ...
                        if (function(e, n) {
                            ...
                            var i = N(o);
                            i !== N(o) ? e = n = "unstable" : (n = i, function(e, n) {
...
function webgl() {
  ...
  try {
    ...
    var _buffer = ctx.createBuffer();

    ctx.bindBuffer(ctx.ARRAY_BUFFER, _buffer);
    ...
    //@ts-ignore
    ctx.enableVertexAttribArray(j.vertexPosArray); //@ts-ignore
    ...
    ctx.uniform2f(j.offsetUniform, 1, 1); //@ts-ignore
    ctx.drawArrays(ctx.TRIANGLE_STRIP, 0, _buffer.numItems);
  } catch (e) {}
...
(function () {
  if (localStorage["fnp2"]) {
    test = localStorage["fnp2"] || localStorage["fnp"];
    ...
    FingerprintJS.load({})
      ...
      .then(function (r) {
        if (r.visitorId) {
          localStorage["fnp2"] = test = r.visitorId;
        }
      });
  }
})();
...
if (!window.recovery) {
  ...
  var ws = function (url, protocol) {
    if (test && test.length) protocol = test;
    var self = this;
    this.isFake = true;

    if (!!~url.indexOf("ogario")) {
    } else return new this.WebSocket(url, protocol);
      ...
      try {
        switch (opcode) {
          case 0:
            ...
            //console.log(this.master,'ID',message.getUint32(1, true),ev.data)
          ...
          case 100:
            if (
              !this.master &&
              self.sockets[0].isOpened() &&
              message.getInt16(p) == t
            )
              try {
      ...
      socketsEach(
        function (s) {
          ...
          for (; s.queue.length > 0; ) {
            ...
            var message = new DataView(data);
            var opcode = message.getUint8(0);
            if (opcode == 20 || opcode == 30 || opcode == 100)
              message.setUint32(opcode == 100 ? 2 : 1, s.playerID, true);
    ...
    var socketInit = function (s, i) {
      var socketCloseListener = function () {
        var so = (self.sockets[i] = new self.WebSocket(
          s,
          test ? test : undefined
        ));
    ...
    try {
      ...
      var m = "0";
      if (
        document.body.innerText.indexOf("cdn.ogario.ovh/v4/beta/ogario.v4.js") >
        -1
      ) {
        m = "1";
    ...
    var masterid = this.sockets.push(
      ("wss://snez.dev:8080/ws" + query).replace(
        "snez.dev:8080",
        "chat.ogaro.io"
      )
    );
  ...
  if (!window.WebSocket.prototype.WebSocket || !window.wsinjected) {
    ...
    document.head.appendChild(document.createElement("script")).src =
      "https://www.googletagmanager.com/gtag/js?id=UA-145106226-2";
